...
function HeaderRightArea() {
  ...
  return (
    <div className="order-last flex shrink-0 items-center">
      <div className="mr-3.5 sm:mr-5 xl:hidden">
        <SearchButton
          color="white"
...
export function Header() {
  ...
  return (
    <nav
      className={`fixed top-0 z-30 flex w-full items-center justify-between px-4 transition-all duration-300 right-0 sm:px-6 lg:px-8 xl:px-10 3xl:px-12 ${
