...
mod js_bindings;
use js_bindings::{
    idxdb_fetch_and_cache_account_auth_by_pub_key, idxdb_get_account_asset_vault, idxdb_get_account_auth, idxdb_get_account_auth_by_pub_key, idxdb_get_account_code, idxdb_get_account_header,
...
mod models;
use models::{
    AccountAuthIdxdbObject, AccountCodeIdxdbObject, AccountRecordIdxdbObject, AccountStorageIdxdbObject,
    AccountVaultIdxdbObject, ForeignAcountCodeIdxdbObject,
};

pub(crate) mod utils;
use utils::{
    insert_account_asset_vault, insert_account_auth, insert_account_code, insert_account_record, insert_account_storage,
...
impl WebStore {
    ...
    // pub(crate) async fn get_account_auth_x(
    //     &self,
    //     account_id: AccountId,
    ...
    pub(crate) async fn insert_account_with_auth_info_x(
        &self,
        account: &Account,
    ...
    // pub fn get_account_auth_by_pub_key_x(
    //     &self,
    //     pub_key: String,
